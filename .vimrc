...
augroup myfiletypes
	...
	autocmd FileType ruby,eruby,yaml,markdown,html,htmljinja,htmldjango,vue.html.javascript.css set ai sw=2 sts=2 et
	autocmd FileType python,js,css set ai sw=4 sts=4 et
augroup END
